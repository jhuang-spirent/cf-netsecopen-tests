...
#cf_controller_address = "10.71.50.219"
cf_controller_address = "10.71.50.105"
# file locations
in_project_dir = True,  # set to true if in main project dir, if set to False provide full path
report_location = "report/CF_10.71.50.105/http_obj_size_no_multicore"
input_location = "input/CF_10.71.50.105/http_obj_size_no_multicore"
output_location = "output/CF_10.71.50.105/http_obj_size_no_multicore"
...
create_tests_base_test_id = '8bf2b0f31c4ab0cf3f07fda6b614086c'
...
test_to_update_csv_file = 'update_tests.csv'
...
get_ipv6_subnets_to_file = 'all_ipv6_subnets.json'
ipv6_subnet_to_file = 'ipv6_subnet.json'
...
update_tests_from_csv = 'update_tests.csv'  # from Global_settings input_location
